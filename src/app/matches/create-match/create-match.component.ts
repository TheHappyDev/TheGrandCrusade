...
export class CreateMatchComponent implements OnInit {
  ...
  deployments: Deployments[] = [
    {id: 1, type: 'itc', name:'Spearhead assault', description:'', imageUrl:'' },
    {id: 2, type: 'itc', name:'Dawn of War', description: '',imageUrl:'' },
    {id: 3, type: 'itc', name:'Search and Destroy', description: '',imageUrl:''  },
    {id: 4, type: 'itc', name:"Hammer and Anvil", description: '',imageUrl:''  },
    {id: 5, type: 'itc', name:'Front-line Assault', description: '',imageUrl:''  },
    {id: 6, type: 'itc', name:'Vanguard Strike', description: '',imageUrl:''  },
  ];
